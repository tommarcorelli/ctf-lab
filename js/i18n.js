...
const UI_STRINGS = {
  fr: {
    ...
    "workspace.back": "Cibles",
    "menu.tools": "Outils", "menu.settings": "Réglages",
    "menu.editor": "Créer une machine", "menu.replay": "Replay de session",
    "menu.sandbox": "Bac à sable libre", "menu.graph": "Graphe d'attaque",
    "menu.stack": "Buffer overflow", "menu.split": "Journal (split)",
    "menu.theme": "Thème", "menu.sound": "Son (capture de flag)",
    "menu.ambient": "Ambiance sonore", "menu.voice": "Narration vocale",
    "menu.fx": "Effets visuels", "menu.lang": "Langue",
  ...
  en: {
    ...
    "workspace.back": "Targets",
    "menu.tools": "Tools", "menu.settings": "Settings",
    "menu.editor": "Create a machine", "menu.replay": "Session replay",
    "menu.sandbox": "Free sandbox", "menu.graph": "Attack graph",
    "menu.stack": "Buffer overflow", "menu.split": "Log (split)",
    "menu.theme": "Theme", "menu.sound": "Sound (flag capture)",
    "menu.ambient": "Ambient sound", "menu.voice": "Voice narration",
    "menu.fx": "Visual effects", "menu.lang": "Language",
